...
public class PushAgentBasic_selector : Agent
{
    /// <summary>
    ...
    /// </summary>
    [HideInInspector]
    public GoalDetect_selector goalDetect;
    ...
    public GameObject go_searcher;
    public GameObject go_pusher;
    PushAgentBasic_searcher searcher;
    PushAgentBasic_pusher pusher;
    /// <summary>
    ...
    {
        searcher = go_searcher.GetComponent<PushAgentBasic_searcher>();
        pusher = go_pusher.GetComponent<PushAgentBasic_pusher>();   
        searcher.is_training = false;
        pusher.is_training = false;
        goalDetect = block.GetComponent<GoalDetect_selector>();
        goalDetect.agent = this;
        self_renderer = cube.GetComponent<Renderer>();
